...
//        }
    ...
    public function getSuppliersByID($product_id = null, $reference = null, $biller = null,$s_start = null, $e_end = null,$pro_code1=null,$wh=null,$cate=null)
    {
        $this->db->select('purchase_items.product_code,erp_products.name,erp_products.unit,purchase_items.warehouse_id,erp_products.category_id
       ')
            ->from('erp_purchase_items')
            ->join('erp_products', 'erp_products.code = erp_purchase_items.product_code','left')
            ->join('erp_purchases' , 'erp_purchases.id = erp_purchase_items.purchase_id','left')
