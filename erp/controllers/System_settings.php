...
class system_settings extends MY_Controller
{
    ...
    function permissions($id = NULL)
    {
        ...
        if ($this->form_validation->run() == true) {
            ...
            $data = array(
                ...
                'products-count_stock' => $this->input->post('count_stock'),
                'products-print_barcode' => $this->input->post('print_barcode'),
				...
				'sales-discount-item' => $this->input->post('discount_by_item'),
				...
				'sales-list_pos' => $this->input->post('list_pos'),
				'sales-list_sale' => $this->input->post('list_sale'),
				'all_warehouses' => $this->input->post('all_warehouses'),
                ...
                'quotes-allow_record' => $this->input->post('quotes-allow_record'),
                ...
                'transfers-net_unit_cost' => $this->input->post('transfers-net_unit_cost'),
                'transfers-subtotal' => $this->input->post('transfers-sub_total'),
    ...
    function getWarehouses()
    {
        ...
        $this->load->library('datatables');
        $this->datatables
            ->select("id, map, id as idd, code, name, phone, email, address")
            ->from("warehouses")
