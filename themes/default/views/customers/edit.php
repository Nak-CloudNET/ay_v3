<div class="modal-dialog modal-lg">
    <div class="modal-content">
        ...
        <div class="modal-footer">
            <?php echo form_submit('edit_customer', lang('edit_customer'), 'class="btn btn-primary edit_customer" id="edit_customer"'); ?>
        </div>
    </div>
    <?php echo form_close(); ?>
</div>
...
<script type="text/javascript" charset="UTF-8">
    $(document).ready(function () {
		...
		$('#phone').bind('change', function (e) {
			...
			$.ajax({
				type: 'GET',
				url: '<?= site_url('customers/check_phone_available'); ?>',
				data: {term:phone},
				cache: false,
