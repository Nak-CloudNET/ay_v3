                            ...
                            <div class="row" id="extras-con" style="display: none;">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <?php echo form_input('discount', $inv->order_discount_id ? $inv->order_discount_id : 0, 'class="form-control input-tip" id="podiscount"'); ?>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group" style="margin-bottom:5px;">
                                        ...
                                        <?php echo form_input('shipping', $this->erp->formatMoney($inv->shipping), 'class="form-control input-tip" id="poshipping"'); ?>
