...
<div class="modal-dialog modal-lg div_modal">
            ...
            <table width="100%">
                ...
                <tr>
                    ...
                    <td style="text-align:right;"><h4>
                            <span><strong><?= $cashsales->paid ? $this->erp->formatMoney(($cashsales->paid + ($cash_in_hand ? $cash_in_hand : $this->session->userdata('cash_in_hand')) - $expense) - ($refunds->returned ? $refunds->returned : 0)) : $this->erp->formatMoney(($cash_in_hand ? $cash_in_hand : $this->session->userdata('cash_in_hand')) - $expense); ?></strong></span>
                        </h4><input type="hidden" id="td_total_cash" value="<?= $cashsales->paid ? ($cashsales->paid + ($cash_in_hand ? $cash_in_hand : $this->session->userdata('cash_in_hand')) - $expense) - ($refunds->returned ? $refunds->returned : 0) : ($cash_in_hand ? $cash_in_hand : $this->session->userdata('cash_in_hand')) - $expense; ?>">
									 </td>
                </tr>
            ...
            <div class="row no-print">
                <div class="col-sm-6">
                    ...
                    <div class="form-group">
                        ...
                        <?= form_hidden('user_close_by', $user_close_by); ?>
