        ...
        <div class="text-center">
				...
				<table style="width: 100%;">				
					<tbody style="font-size: 12px;">						
						<tr style="text-align:center;">	
							...
							<td style="vertical-align:middle;text-align:left;">$1 = R <?= $inv->other_cur_paid_rate; ?></td>
            ...
            <table class="table-condensed receipt no_border_btm" style="width:100%;">
                ...
                <?php
					...
					foreach ($rows as $row) {
						...
						echo '	<td class="text-center"  style="text-align:right;">$ ' . $this->erp->formatMoney($row->unit_price) . '</td>';
			...
			<table style="width: 100%; margin-top: 5px;">
				...
				<tr>
					...
					<?php
					echo $this->erp->formatMoney($sub_total - $inv->order_discount);
					?>
					</td>
				</tr>
				<?php if($inv->customer_id != 4) { ?>
					<tr>
						<td style="text-align:left;">ពិន្ទុសរុប</td>
						<td style="text-align:right;width:40%;">Total Award Points :</td>
						<td style="text-align:right;"><?php echo $inv->award_points; ?>
						</td>
					</tr>
				<?php } ?>
				<?php
			...
			<tr style="display:none;">
				...
				?>
					<table style="width:100%;">
						...
						<tr>
							<th style="border:2px solid #000;border-right:none;padding-right: 12px;width:81%;" colspan="<?= $colspan ?>" class="text-right">Received(USD):</th>
				...
				?>
					<tr>
                        <th style="border:2px solid #000;border-right:none;padding-right: 12px;" colspan="<?= $colspan ?>" class="text-right">Received(USD):</th>
			...
			<div style="text-align:center;font-size:13px;margin-top:10px;">
				...
				Goods sold not returnable<br>
				អរគុណចំពោះការទិញទំនិញនៅហាងយើងខ្ញុំ&#8203; សូមអញ្ជើញមកម្ដងទៀត<br>
				Thank you for shopping at our shop, Please come again<br>	
				~ ~ ~ <b>CloudNet</b> &nbsp;&nbsp;&nbsp;&nbsp;<span style="font-size:12px;">www.cloud--net.com</span> ~ ~ ~
			</div>
...
<?php } ?>
	...
	<!-- <span class="pull-right col-xs-12">
        <a href="<?=base_url()?>sales/print_gift_receipt/<?=$sid?>" target="_blank" class="btn btn-block btn-primary" ><?= lang("gift_receipt"); ?></a>
    </span> -->
	...
	<!-- <span class="pull-right col-xs-12">
        <a href="<?=base_url()?>sales/invoice_poto/<?=$sid?>" target="_blank" class="btn btn-block btn-primary" ><?= lang("invoice_poto"); ?></a>
    </span> -->
	<span class="pull-right col-xs-12">
