                                                ...
                                                <div id="botbuttons" style="text-align:center;">
                                                    ...
                                                    <div class="btn-group btn-group-justified">
                                                        <div class="btn-group">
                                                            <div class="btn-group btn-group-justified">
                                                                <div class="btn-group">
                                                                    <button type="button" title="Cancel Order - <?= $pos_settings->cancel_sale ?>" style="<?php echo ($layout == 6?'height:85px':'height:73px') ?>" class="btn btn-danger <?php echo ($layout == 6?'font6':'') ?>" id="reset">
                                                        ...
                                                        <?php } ?>
                                                        <div class="btn-group">
                                                            <button type="button" title="Payment - <?= $pos_settings->finalize_sale ?>" style="<?php echo ($layout == 6?'height:85px':'height:73px') ?>" class="btn btn-success <?php echo ($layout == 6?'font6':'') ?>" id="payment">
				...
				*/
                    ...
                    $(document).ready(function () {
                        ...
                        $('#print_order_food').click(function () {
                            ...
                            //$('#posTable').load('pos/index #posTable');
