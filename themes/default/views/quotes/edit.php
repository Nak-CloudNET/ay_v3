<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        localStorage.setItem('qunote', "<?= mysql_real_escape_string($inv->note); ?>");
                    ...
                    <div class="col-lg-12">
                        <?php if ($Owner || $Admin) { ?>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <?= lang("date", "qudate"); ?>
                                    <?php echo form_input('date', (isset($_POST['date']) ? $_POST['date'] : ""), 'class="form-control input-tip datetime" style="pointer-events:none;" id="qudate" required="required"'); ?>
                                </div>
                            </div>
                        <?php } ?>
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <?php echo form_input('reference_no', (isset($_POST['reference_no']) ? $_POST['reference_no'] : ''), 'class="form-control input-tip" style="pointer-events:none;" id="quref" required="required"'); ?>
                            </div>
                        </div>
                        <?php if ($Owner || $Admin || !$this->session->userdata('biller_id')) { ?>
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    echo form_dropdown('biller', $bl, (isset($_POST['biller']) ? $_POST['biller'] : $inv->biller_id), 'id="qubiller" data-placeholder="' . $this->lang->line("select") . ' ' . $this->lang->line("biller") . '" required="required" style="pointer-events:none;" class="form-control input-tip select" style="width:100%;"');
                                    ?>
                                </div>
                            </div>
                        <?php } else {
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <?php $st = array('pending' => lang('pending'), 'cancel' => lang('cancel'), 'completed' => lang('completed'));
                        ...
                        <div class="col-md-12">
                            <div class="panel panel-warning">
                                ...
                                <div class="panel-body" style="padding: 5px;">
                                    ...
                                    <?php } else {
                                        echo form_hidden('warehouse', $this->session->userdata('warehouse_id'), 'id="quwarehouse"');
                                    } ?>
                                    <div class="col-md-4">
                                        <div class="form-group">
