                            ...
                            <table class="table table-bordered table-hover table-striped">
                                ...
                                <tr>
                                    ...
                                    <td>
										...
										<input type="checkbox" value="1" id="all_warehouses" class="checkbox"
                                               name="all_warehouses" <?php echo $p->{'all_warehouses'} ? "checked" : ''; ?>><label
                                            for="all_warehouses"
                                            class="padding05"><?= lang('all_warehouses') ?></label>
										<input type="checkbox" value="1" id="count_stock" class="checkbox"
                                               name="count_stock" <?php echo $p->{'products-count_stock'} ? "checked" : ''; ?>><label
                                            for="product-count_stock"
                                            class="padding05"><?= lang('count_stock') ?></label>
										<input type="checkbox" value="1" id="print_barcode" class="checkbox"
                                               name="print_barcode" <?php echo $p->{'products-print_barcode'} ? "checked" : ''; ?>><label
                                            for="product-print_barcode"
                                            class="padding05"><?= lang('print_barcode') ?></label>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td>
										...
										<input type="checkbox" value="1" id="discount_by_item" class="checkbox"
                                               name="discount_by_item" <?php echo $p->{'sales-discount-item'} ? "checked" : ''; ?>><label
                                            for="discount_by_item"
                                            class="padding05"><?= lang('discount_by_item') ?></label>
										...
										<input type="checkbox" value="1" id="list_pos" class="checkbox"
                                               name="list_pos" <?php echo $p->{'sales-list_pos'} ? "checked" : ''; ?>><label
                                            for="sales-list_pos"
                                            class="padding05"><?= lang('list_pos') ?></label>
										<input type="checkbox" value="1" id="list_sale" class="checkbox"
                                               name="list_sale" <?php echo $p->{'sales-list_sale'} ? "checked" : ''; ?>><label
                                            for="sales-list_sale"
                                            class="padding05"><?= lang('list_sale') ?></label>
										<input type="checkbox" value="1" id="close_register" class="checkbox"
                                               name="close_register" <?php echo $p->{'close_register'} ? "checked" : ''; ?>><label
                                            for="close_register"
                                            class="padding05"><?= lang('close_register') ?></label>
                                    </td>
                                </tr>
                            ...
                            <!--    <tr>
                                ...
                                <tr>
                                    ...
                                    <td>
										<input type="checkbox" value="1" id="quotes-email" class="checkbox"
                                               name="quotes-allow_record" <?php echo $p->{'quotes-allow_record'} ? "checked" : ''; ?>><label
                                            for="quotes-allow_record" class="padding05"><?= lang('allow_record') ?></label>
                                    <!--    <input type="checkbox" value="1" id="quotes-email" class="checkbox"
                                ...
                                <tr>
                                    ...
                                    <td>
										...
										<input type="checkbox" value="1" id="transfers-net_unit_cost" class="checkbox"
                                               name="transfers-net_unit_cost" <?php echo $p->{'transfers-net_unit_cost'} ? "checked" : ''; ?>><label
                                            for="transfers-email" class="padding05"><?= lang('net_unit_cost') ?></label>
										<input type="checkbox" value="1" id="transfers-sub_total" class="checkbox"
                                               name="transfers-sub_total" <?php echo $p->{'transfers-subtotal'} ? "checked" : ''; ?>><label
                                            for="transfers-email" class="padding05"><?= lang('subtotal') ?></label>
                                    </td>
