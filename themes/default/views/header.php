            ...
            <div class="row" id="main-con">
                <div id="sidebar-left" class="col-lg-2 col-md-2">
                    <div class="sidebar-nav nav-collapse collapse navbar-collapse" id="sidebar_menu">
                            ...
                            ?>
                                ...
                                <li class="mm_products">
                                    ...
                                    <ul>
										...
										<!----Stock Count--->
										<li id="products_stock_count" class="sub_navigation">
                                            <a class="submenu" href="<?= site_url('products/stock_count'); ?>">
                                                <i class="fa fa-list-ol"></i>
                                                <span class="text"> <?= lang('stock_count_by_barcode'); ?></span>
                                            </a>
                                        </li>
                            ...
                            ?>
                                            <?php if ($GP['products-index']) { ?>
                                                    ...
                                                    <ul>
                                                        ...
                                                        <?php if ($GP['products-add']) { ?>
                                                            ...
                                                            <?php } ?>
																...
																<?php if ($GP['products-print_barcode']) { ?>
																	<li id="products_print_barcodes" class="sub_navigation">
																		<a class="submenu" href="<?= site_url('products/print_barcodes'); ?>">
																			<i class="fa fa-tags"></i>
																			<span class="text"> <?= lang('print_barcode_label'); ?></span>
                                                                ...
                                                                <?php if ($GP['products-adjustments']) { ?>
                                                                    ...
                                                                    <?php } ?>
															<!--	<li id="products_update_count" class="sub_navigation">
																	<a class="submenu" href="<?= site_url('products/stock_count'); ?>">
																		<i class="fa fa-list-ol"></i>
																		<span class="text"> <?= lang('stock_count'); ?></span>
																	</a>
																</li> -->
																<!----Stock Count--->
																<?php if ($GP['products-count_stock']) { ?>
																<!--	<li id="products_stock_count" class="sub_navigation">
																		<a class="submenu" href="<?= site_url('products/stock_count'); ?>">
																			<i class="fa fa-list-ol"></i>
																			<span class="text"> <?= lang('stock_count_by_barcode'); ?></span>
                                                ...
                                                <?php } ?>
                                                    ...
                                                    <?php if ($GP['sales-list_pos']) /*if ($GP['sales-index'])*/ { ?>
                                                        <li class="mm_sales <?= strtolower($this->router->fetch_method()) == 'settings' ? '' : 'mm_pos' ?>">
                                                            <a class="dropmenu" href="#">
                                                                <i class="fa fa-heart"></i>
                                                                <span class="text"> <?= lang('manage_sales'); ?> 
						...
						<?php if ($GP['reports-products'] || $GP['reports-purchases'] || $GP['reports-sales'] || $GP['reports-account']) { ?>
                                                                                                <li class="mm_reports">
                                                                                                    <a class="dropmenu" href="#">
                                                                                                        <i class="fa fa-bar-chart-o"></i>
                                                                                                        <span class="text"> <?= lang('reports'); ?> </span>
