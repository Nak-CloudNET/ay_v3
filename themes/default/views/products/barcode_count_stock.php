        ...
        function loadStorage(){
            ...
            if(poitems != null)
            {
                ...
                $.each(poitems, function (i,e) {
                    var qty = e.quantity;
                    v += "<tr><td class='center'><input type='checkbox' /></td><td class='center'>"+k+"<input type='hidden' class='pro_id' value='"+e.item_id+"' ></td><td>"+e.code+"</td><td>"+e.label+"</td><td>"+e.variant+"</td><td class='center'>"+qty+"</td><td style='font-size:28px; font-weight:bold; color:red;' class='center pro_qty'>"+e.qty+"</td></tr>";
                    k++;
                });
                $(".tbody").html(v);
            }
