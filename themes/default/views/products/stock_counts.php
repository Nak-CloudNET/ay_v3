...
<script>
    ...
    $(document).ready(function () {
        ...
        oTable = $('#STData').dataTable({
            ...
            "aoColumns": [
                {"bSortable": false, "mRender": checkbox}, {"mRender": fld}, null, null, null, null, {"bSortable": false, "mRender": attachment}, {"bSortable": false}
            ]
...
<div class="box">
    <div class="box-header">
        ...
        <div class="box-icon">
            <ul class="btn-tasks">
                <li class="dropdown">
                    <a href="<?= site_url('products/finalize_count') ?>" class="tip" data-placement="top" title="<?= lang("count_stock") ?>">
                    ...
                    <table id="STData" class="table table-bordered table-condensed table-hover table-striped">
                        ...
                        <tfoot class="dtFilter">
							<tr class="active">
								...
								<th></th>
								<th></th>
								<th style="max-width:40px; text-align:center;"><i class="fa fa-chain"></i></th>
